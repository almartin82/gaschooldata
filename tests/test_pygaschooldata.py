...
def get_test_years():
    ...
    if _available_years is None:
        ...
        _available_years = ga.get_available_years()
...
class TestImport:
    ...
    def test_import_functions(self):
        ...
        import pygaschooldata as ga
        assert hasattr(ga, 'fetch_enr')
        assert hasattr(ga, 'fetch_enr_multi')
        assert hasattr(ga, 'tidy_enr')
        assert hasattr(ga, 'get_available_years')

    def test_version_exists(self):
        """Package has a version string."""
        import pygaschooldata as ga
        assert hasattr(ga, '__version__')
...
class TestFetchEnr:
    ...
    def test_returns_dataframe(self):
        ...
        df = ga.fetch_enr(years['max_year'])
    ...
    def test_total_enrollment_reasonable(self):
        ...
        years = get_test_years()
        df = ga.fetch_enr(years['max_year'])
        # Total enrollment in Georgia varies by grade level aggregation
        # Just check that total is positive and reasonable
        total = df['n_students'].sum()
        # Georgia should have substantial enrollment
...
class TestFetchEnrMulti:
    ...
    def test_returns_dataframe(self):
        ...
        df = ga.fetch_enr_multi([years['max_year']])
        assert isinstance(df, pd.DataFrame)
    ...
    def test_contains_requested_year(self):
        ...
        df = ga.fetch_enr_multi([test_year])
    ...
    def test_multi_matches_single(self):
        ...
        import pygaschooldata as ga
        years = get_test_years()
        df_single = ga.fetch_enr(years['max_year'])
        df_multi = ga.fetch_enr_multi([years['max_year']])
