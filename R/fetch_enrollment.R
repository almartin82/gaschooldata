...
# ==============================================================================
#
# This file contains the main user-facing functions for fetching Georgia
# enrollment data from the Governor's Office of Student Achievement (GOSA).
#
# ==============================================================================

#' Fetch Georgia enrollment data
#'
#' Downloads and returns enrollment data from the Governor's Office of Student
#' Achievement (GOSA).
#'
